...
def get_michaelis_menten_params(initial_guess, model, t_span: tuple, Vmax_bound: tuple, Km_bound: tuple, V: int | float, 
                ke: int | float, f: float, dose_ug, tmax_target, cmax_target, auc_target, ke_pro: int | float = None):
    
    ka = get_ka(ke, tmax_target)
